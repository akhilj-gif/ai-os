// Kernel (blueprint §4.1) — M0 scope: prove the substrate end-to-end.
// runHelloWorldTask exercises every M0 exit criterion in one path:
// a durable Task row → a traced model call → TraceEvents in Postgres → a Langfuse trace.
// Session Manager / Planner / Task Graph / Executor Loop / Context Engine arrive in M1+.
