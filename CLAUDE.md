...
- Rolling: failure corpus **21/50** (FC-013..021, all dogfood from the OS's own runs + reviews); `support-triage` needs ~20 real tickets before its suite is built. **Next: M3 — Memory v1 + Context Engine.**
