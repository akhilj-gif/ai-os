...
export default function AIOrb({ state = 'idle', onClick }: { state?: VoiceState; onClick?: () => void }) {
  const cfg = STATE[state];
  return (
    <button
      onClick={onClick}
      className="relative w-[400px] h-[400px] flex items-center justify-center outline-none cursor-pointer"
